...
# Usage: Installing dependencies for biochemistry-virtual-lab-I
RUN apt-get install -y make rsync apache2 wget php5

RUN mkdir /biochemistry-virtual-lab-I

COPY src/ /biochemistry-virtual-lab-I/src

WORKDIR ./biochemistry-virtual-lab-I/src
